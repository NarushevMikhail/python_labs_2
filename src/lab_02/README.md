...
## Процесс создания коллекции: 
 ```Контейнер``` – это класс, который предназначен для хранения, организации и управления группой других объектов. Он предоставляет методы для добавления, удаления, поиска и перебора хранимых элементов.
